<div class="panel panel-default">
    <div class="panel-heading" role="tab" id="help_collapse_tc11_heading">
        <h4 class="panel-title">
            <a role="button" data-toggle="collapse" data-parent="#tchelp_accordion" href="#help_collapse_tc11" aria-expanded="true" aria-controls="help_collapse_tc11">
                Teamcenter 11.2
            </a>
        </h4>
    </div>
    <div id="help_collapse_tc11" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="help_collapse_tc11_heading">
        <div class="panel-body">
            <p class="text-muted">(Начиная с этой версии поиск по справке осуществляется на сервере - без Java в браузере)</p>
            <ul>
                <li class="list-unstyled"><h4>11.2.1</h4></li>
                ...
                <li class="list-unstyled"><h4>11.2</h4></li>
                ...
                <li><a target="_blank" href="http://10.10.14.16:8181/tdoc/tc/11.2/PDF_ru/">PDF Русская</a></li>
                <li><a target="_blank" href="http://10.10.14.16:8181/tdoc/tc/11.2/PDF/">PDF English</a></li>
            </ul>
        </div>
    </div>
</div>